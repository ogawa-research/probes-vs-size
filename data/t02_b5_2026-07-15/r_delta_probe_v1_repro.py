...
CLIP_FLOOR = 1e-45  # G2a repro: temporarily reverted to v1 value to A/B against v2 on same GPU
...
class AttnStatsHook:
    ...
    def __call__(self, module, inputs, output):
        ...
        # G2a repro: assert intentionally disabled to reproduce v1's silent
        # no-op clamp behavior for direct A/B comparison against v2 on the
        # same GPU (v2 keeps this assert; see r_delta_probe.py).
